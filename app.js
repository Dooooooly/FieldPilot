...
css += 'body.dark-mode h1, body.dark-mode h2, body.dark-mode h3, body.dark-mode h4, body.dark-mode h5 { color: #f7fafc !important; } ';
css += 'body.dark-mode p, body.dark-mode label, body.dark-mode span, body.dark-mode div, body.dark-mode li { color: #e2e8f0; } ';
css += 'body.dark-mode a { color: #63b3ed !important; } ';
// ===== 헤더 영역 =====
css += 'body.dark-mode header, body.dark-mode .app-header, body.dark-mode .header-row { background: #2d3748 !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode #weatherDisplay { background: transparent !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode #currentRegionName { color: #63b3ed !important; } ';
css += 'body.dark-mode #regionSelect { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode #startPoint, body.dark-mode #waypointInput { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode #startInfo { color: #a0aec0 !important; } ';
// ===== 탭 콘텐츠 배경 =====
css += 'body.dark-mode .tab-content { background: #1a202c !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode .tab-content > div { background: #1a202c !important; } ';
css += 'body.dark-mode .section-title { color: #f7fafc !important; } ';
css += 'body.dark-mode .card { background: #2d3748 !important; border-color: #4a5568 !important; color: #e2e8f0 !important; } ';
// ===== 하단 탭 =====
css += 'body.dark-mode .bottom-tabs { background: #2d3748 !important; border-top-color: #4a5568 !important; } ';
css += 'body.dark-mode .bottom-tab { color: #a0aec0 !important; background: transparent !important; } ';
css += 'body.dark-mode .bottom-tab.active { color: #63b3ed !important; background: rgba(99,179,237,0.1) !important; } ';
// ===== 입력 요소 =====
css += 'body.dark-mode input, body.dark-mode textarea, body.dark-mode select { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode input::placeholder, body.dark-mode textarea::placeholder { color: #718096 !important; } ';
css += 'body.dark-mode input:focus, body.dark-mode textarea:focus, body.dark-mode select:focus { border-color: #63b3ed !important; } ';
// ===== 버튼 =====
css += 'body.dark-mode .btn { background: #4a5568 !important; color: #e2e8f0 !important; border-color: #718096 !important; } ';
css += 'body.dark-mode .btn:hover { background: #5a6a7e !important; } ';
css += 'body.dark-mode .btn-primary { background: #3182ce !important; color: white !important; border-color: #3182ce !important; } ';
css += 'body.dark-mode .btn-outline { background: transparent !important; color: #cbd5e0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .btn-outline:hover { background: #4a5568 !important; } ';
css += 'body.dark-mode .btn-danger, body.dark-mode .btn[style*="e53e3e"] { background: #e53e3e !important; color: white !important; } ';
// ===== 리스트 아이템 =====
css += 'body.dark-mode .place-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .place-item:hover { background: #3a4556 !important; } ';
css += 'body.dark-mode .place-item .name { color: #f7fafc !important; } ';
css += 'body.dark-mode .place-item .addr, body.dark-mode .addr { color: #a0aec0 !important; } ';
css += 'body.dark-mode .route-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .route-item:hover { background: #3a4556 !important; } ';
css += 'body.dark-mode .route-item .name { color: #f7fafc !important; } ';
css += 'body.dark-mode .route-start { background: rgba(74,85,104,0.4) !important; } ';
css += 'body.dark-mode .result-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .result-item:hover { background: #3a4556 !important; } ';
css += 'body.dark-mode .result-info { color: #e2e8f0 !important; } ';
css += 'body.dark-mode .source { background: #4a5568 !important; color: #cbd5e0 !important; } ';
css += 'body.dark-mode .remark { background: #4a5568 !important; color: #cbd5e0 !important; } ';
css += 'body.dark-mode .empty-msg { color: #718096 !important; } ';
css += 'body.dark-mode .waypoint-list li { background: #2d3748 !important; color: #e2e8f0 !important; } ';
// ===== 배지/태그 =====
css += 'body.dark-mode .badge { background: #4a5568 !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode .badge-ok { background: #276749 !important; color: #c6f6d5 !important; } ';
css += 'body.dark-mode .badge-wait { background: #744210 !important; color: #fefcbf !important; } ';
css += 'body.dark-mode .badge-fail { background: #9b2c2c !important; color: #fed7d7 !important; } ';
// ===== 경로 요약 카드 =====
css += 'body.dark-mode #placeCount, body.dark-mode #totalDistance, body.dark-mode #totalTime, body.dark-mode #optimizeMode { color: #f7fafc !important; } ';
css += 'body.dark-mode #savedAmount { color: #68d391 !important; } ';
css += 'body.dark-mode #optimizationStatus { color: #a0aec0 !important; } ';
css += 'body.dark-mode #modeStatus { color: #a0aec0 !important; } ';
// ===== 프리셋 =====
css += 'body.dark-mode .preset-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .preset-item:hover { background: #3a4556 !important; } ';
css += 'body.dark-mode .preset-name { color: #f7fafc !important; } ';
css += 'body.dark-mode .preset-detail { color: #a0aec0 !important; } ';
css += 'body.dark-mode .preset-delete { color: #fc8181 !important; } ';
// ===== GitHub/설정 탭 =====
css += 'body.dark-mode .commit-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode .commit-msg { color: #f7fafc !important; } ';
css += 'body.dark-mode .commit-date { color: #a0aec0 !important; } ';
css += 'body.dark-mode .restore-btn { background: #3182ce !important; color: white !important; } ';
css += 'body.dark-mode #storageInfo { color: #a0aec0 !important; } ';
css += 'body.dark-mode #uploadResult { color: #1a202c !important; } ';
css += 'body.dark-mode .region-item { background: #2d3748 !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode .region-item.active { background: #2c5282 !important; color: #ebf8ff !important; } ';
// ===== 통계 탭 =====
css += 'body.dark-mode #statsContent { color: #e2e8f0 !important; } ';
css += 'body.dark-mode #statsContent > div { background: transparent !important; } ';
css += 'body.dark-mode .stats-period-btn { background: #4a5568 !important; color: #e2e8f0 !important; border-color: #718096 !important; } ';
css += 'body.dark-mode .stats-period-btn.active { background: #3182ce !important; color: white !important; border-color: #3182ce !important; } ';
css += 'body.dark-mode #statsVisitData > div { background: #2d3748 !important; } ';
css += 'body.dark-mode #statsVisitData div[style*="f7fafc"] { background: #2d3748 !important; } ';
css += 'body.dark-mode #statsVisitData div[style*="2b6cb0"] { color: #63b3ed !important; } ';
css += 'body.dark-mode #statsVisitData div[style*="38a169"] { color: #68d391 !important; } ';
css += 'body.dark-mode #statsVisitData div[style*="718096"] { color: #a0aec0 !important; } ';
// ===== 상태/알림 =====
css += 'body.dark-mode .tab-status { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
css += 'body.dark-mode #offlineBanner { background: #744210 !important; color: #fefcbf !important; } ';
// ===== 지도 =====
css += 'body.dark-mode #map { filter: brightness(0.85) contrast(1.1); } ';
// ===== 모달 전체 =====
...
css += 'body.dark-mode #confirmModal h3, body.dark-mode #promptModal h3, body.dark-mode #customRegionModal h3, body.dark-mode #customPresetModal h3, body.dark-mode #regionManagerModal h3, body.dark-mode #weekWeatherModal h3, body.dark-mode #modal h3, body.dark-mode #optimizeSettingsModal h3 { color: #f7fafc !important; } ';
css += 'body.dark-mode #confirmModal p, body.dark-mode #promptModal p, body.dark-mode #customRegionModal p, body.dark-mode #customPresetModal p { color: #cbd5e0 !important; } ';
// ===== 종료 확인 모달 =====
css += 'body.dark-mode #exitConfirmModal > div { background: #2d3748 !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode #exitConfirmModal h3 { color: #f7fafc !important; } ';
css += 'body.dark-mode #exitConfirmModal p { color: #cbd5e0 !important; } ';
css += 'body.dark-mode #exitCancelBtn { background: #4a5568 !important; color: #e2e8f0 !important; border-color: #718096 !important; } ';
css += 'body.dark-mode #exitConfirmBtn { background: #e53e3e !important; color: white !important; } ';
// ===== 즐겨찾기/아이콘 =====
css += 'body.dark-mode .fav.active { color: #ecc94b !important; } ';
css += 'body.dark-mode .fav.inactive { color: #718096 !important; } ';
css += 'body.dark-mode .idx { color: white !important; } ';
css += 'body.dark-mode .drag-handle { color: #a0aec0 !important; } ';
css += 'body.dark-mode .remove { color: #fc8181 !important; } ';
// ===== 통계 기록 안내 문구 =====
css += 'body.dark-mode div[style*="f7fafc"] { background: #2d3748 !important; } ';
css += 'body.dark-mode div[style*="dashed"] { border-color: #4a5568 !important; color: #a0aec0 !important; } ';
// ===== 도움말 탭 =====
css += 'body.dark-mode #tab-help { background: #1a202c !important; color: #e2e8f0 !important; } ';
css += 'body.dark-mode #tab-help h3, body.dark-mode #tab-help h4 { color: #f7fafc !important; } ';
css += 'body.dark-mode #tab-help li { color: #cbd5e0 !important; } ';
// ===== 기타 =====
css += 'body.dark-mode #darkModeToggleBtn:hover { background: rgba(255,255,255,0.1) !important; } ';
css += 'body.dark-mode .dist { color: inherit !important; } ';
