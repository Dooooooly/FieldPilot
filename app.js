...
function injectDarkModeCSS() {
    ...
    css += 'body.dark-mode .tab-content, body.dark-mode .tab-content > div { background: #1a202c !important; color: #e2e8f0 !important; } ';
    css += 'body.dark-mode .bottom-tabs { background: #2d3748 !important; border-top-color: #4a5568 !important; } ';
    css += 'body.dark-mode .bottom-tab { color: #a0aec0 !important; } ';
    ...
    css += 'body.dark-mode .place-item, body.dark-mode .route-item, body.dark-mode .preset-item, body.dark-mode .commit-item { background: #2d3748 !important; color: #e2e8f0 !important; border-color: #4a5568 !important; } ';
    css += 'body.dark-mode .place-item:hover, body.dark-mode .route-item:hover { background: #3a4556 !important; } ';
    css += 'body.dark-mode .place-item .name, body.dark-mode .route-item .name { color: #f7fafc !important; } ';
    css += 'body.dark-mode .place-item .addr, body.dark-mode .route-item .addr, body.dark-mode .addr { color: #a0aec0 !important; } ';
    ...
    css += 'body.dark-mode h1, body.dark-mode h2, body.dark-mode h3, body.dark-mode h4 { color: #f7fafc !important; } ';
    css += 'body.dark-mode p, body.dark-mode label, body.dark-mode span { color: #e2e8f0 !important; } ';
    css += 'body.dark-mode .section-title, body.dark-mode .card { background: #2d3748 !important; border-color: #4a5568 !important; } ';
    css += 'body.dark-mode .tab-status { background: #2d3748 !important; color: #e2e8f0 !important; } ';
    ...
    css += 'body.dark-mode .info .name { color: #f7fafc !important; } ';
    css += 'body.dark-mode .info .addr { color: #a0aec0 !important; } ';
    css += 'body.dark-mode #weatherDisplay { background: transparent !important; color: #e2e8f0 !important; } ';
    css += 'body.dark-mode .preset-item .preset-name { color: #f7fafc !important; } ';
    css += 'body.dark-mode .preset-item .preset-detail { color: #a0aec0 !important; } ';
    ...
    css += 'body.dark-mode .route-start { background: rgba(74, 85, 104, 0.3) !important; } ';
    css += 'body.dark-mode #regionSelect { background: #2d3748 !important; color: #e2e8f0 !important; } ';
    css += 'body.dark-mode #sortPlaces { background: #2d3748 !important; color: #e2e8f0 !important; } ';
