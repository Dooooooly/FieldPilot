...
function createMap(container) {
    try {
        ...
        // 용산구 중심 좌표 (37.5326, 126.9900)
        var centerLat = 37.5326;
        var centerLng = 126.9900;
        var zoomLevel = 14; // 용산구 전체가 보이는 줌레벨
